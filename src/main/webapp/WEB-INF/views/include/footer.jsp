...
<footer id="footer" class="clear">
	<div class="one_third first">
		...
		<ul class="nospace">
			<li class="push10"><span class="icon-time"></span> Mon. - Fri.
				9:00am - 7:00pm</li>
			<li class="push10"><span class="icon-phone"></span> +00 (123)
				456 7890</li>
	...
	<div class="one_third">
		...
		<ul class="nospace clear">
			<li class="clear push30">
				...
				<p class="nospace push15">Integer imperdiet vestibulum leo ut
					tincidunt in sagittis.</p>
				<p class="nospace">
	...
	<div class="one_third">
		...
		<ul class="nospace clear ftgal">
			<li class="one_third first"><a href="#"><img
					src="../images/demo/100x100.gif" alt=""></a></li>
